...
import 'package:nutri/src/features/worker/features/service/src/models.dart';
import 'package:nutri/src/features/worker/features/service/src/widgets/add_service_button.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton:
          AddServiceButton(userid: widget.userid, service: service),
      body: Form(
        child: Column(
          children: [
